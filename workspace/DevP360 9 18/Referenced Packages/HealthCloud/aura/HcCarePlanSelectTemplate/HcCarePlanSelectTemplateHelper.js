({
    ...
    handleTemplateAddEvent: function(component, event, helper) {
        ...
        if (Object.keys(selectedItems).length >= selectedTemplateCountLimit) {
            ...
            toast.set('v.content', { 'type': 'warning', 'message': HC.format($A.get("$Label.HealthCloudGA.Msg_Info_CarePlanTemplateWizard_Selection_Count"), selectedTemplateCountLimit) });
