...
({
    doInit: function(component, event, helper) {
        ...
        helper.getProblems(component, event, helper);
        helper.setupTabs(component, event, helper);
    },
    ...
    handleDataChangedEvent: function(component, event, helper) {
        ...
        helper.handleRefresh(component, helper, sObjectName, recordId, newParentId, oldParentId, topLevelParentId,event);
        helper.handleStaleProblemsTab(component, sObjectName);
    },
    ...
    openCarePlanTemplates: function(component) {
        HC.openCarePlanTemplatesSubtab(component.get("v.carePlanId"), component.get("v.patientId"), HC.format($A.get("$Label.HealthCloudGA.Tab_Title_Careplan_Templates"), component.get("v.carePlanSubject")), component.get("v.namespaceDash"));
        var problemsMenu = component.find("problemsMenu");
        problemsMenu.set("v.visible", false);
    },
